    ...
    <div className="homepage-container flex flex-col md:flex-row items-center p-8 bg-white">
      ...
      <div className="md:w-1/2">
        ...
        <p className="mt-4 text-lg text-gray-600">
          ...
          attention, ensuring thorough cleaning, ironing and folding. With their
          expertise, you can trust that your clothes will be handled
          professionally and returned returned to you in pristine condition.
        </p>
